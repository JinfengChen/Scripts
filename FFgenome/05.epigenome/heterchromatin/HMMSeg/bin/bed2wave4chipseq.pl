#!/usr/bin/perl
=header
The script is designed to generate a bed format file (we call wave here) for window view chipseq on genome.
...
if ($opt{help} or keys %opt < 1){
   print "Usage: run perl $0 --window 50000 --step 50000 -chrlen rice.chrlen -bar ric_H3K4_wave -bed rice_H3K4_bed\n";
   exit();
}
$opt{window} ||= 50000;
$opt{step} ||= 50000;
