...
print OUT2 "$gene_number\t$average_mRNA_length\t$average_cds_length\t$average_exon_number\t$average_exon_length\t$average_intron_length\t$average_intron_length2\t$total_exon_number\t$total_intron_number\t$total_intron_length\t$total_intron_length2\n";		
close OUT1;
close OUT2;
close OUT3;
close OUT4;
