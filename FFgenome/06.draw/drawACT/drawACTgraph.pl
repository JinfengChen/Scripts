...
if (exists $opt{qRNAseq}){
  $svg=graph($svg,"100","250",$opt{qRNAseq},"50",$rate1,"RNAseq","Purple");
}
##query mC
if (exists $opt{qmC}){
  $svg=graph($svg,"100","200",$opt{qmC},"50",$rate1,"mC","brown");
}
##query H3K4
if (exists $opt{qH3K4}){
  $svg=graph($svg,"100","150",$opt{qH3K4},"50",$rate1,"H3K4","cyan");
}
##query H3K9
if (exists $opt{qH3K9}){
  $svg=graph($svg,"100","100",$opt{qH3K9},"50",$rate1,"H3K9","Orange");
}

##target RNAseq
if (exists $opt{tRNAseq}){
  $svg=graph($svg,"100","590",$opt{tRNAseq},"50",$rate2,"RNAseq","Purple");
}
##target mC
if (exists $opt{tmC}){
  $svg=graph($svg,"100","640",$opt{tmC},"50",$rate2,"mC","brown");
}
##target H3K4
if (exists $opt{tH3K4}){
  $svg=graph($svg,"100","690",$opt{tH3K4},"50",$rate2,"H3K4","cyan");
}
##target H3K9
if (exists $opt{tH3K9}){
  $svg=graph($svg,"100","740",$opt{tH3K9},"50",$rate2,"H3K9","Orange");
}
######### draw legend
