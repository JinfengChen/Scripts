...
our $querypos=400;
our $targetpos=590;
my $rate1=$qlength > $tlength ? $qlength/($width-200) : $tlength/($width-200);
my $rate2=$rate1;
...
if (exists $opt{qRNAseq}){
  $svg=graph($svg,"100","300",$opt{qRNAseq},"500",$rate1,"RNAseq","Purple");
}
##query mC
if (exists $opt{qmC}){
  $svg=graph($svg,"100","250",$opt{qmC},"500",$rate1,"mC","brown");
}
##query H3K4
if (exists $opt{qH3K4}){
  $svg=graph($svg,"100","200",$opt{qH3K4},"500",$rate1,"H3K4","cyan");
}
##query H3K9
if (exists $opt{qH3K9}){
  $svg=graph($svg,"100","150",$opt{qH3K9},"500",$rate1,"H3K9","Orange");
}

##target RNAseq
if (exists $opt{tRNAseq}){
  $svg=graph($svg,"100","740",$opt{tRNAseq},"500",$rate2,"RNAseq","Purple");
}
##target mC
if (exists $opt{tmC}){
  $svg=graph($svg,"100","790",$opt{tmC},"500",$rate2,"mC","brown");
}
##target H3K4
if (exists $opt{tH3K4}){
  $svg=graph($svg,"100","840",$opt{tH3K4},"500",$rate2,"H3K4","cyan");
}
##target H3K9
if (exists $opt{tH3K9}){
  $svg=graph($svg,"100","890",$opt{tH3K9},"500",$rate2,"H3K9","Orange");
}
######### draw legend
