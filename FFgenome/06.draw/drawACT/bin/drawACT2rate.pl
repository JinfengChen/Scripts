...
########################### drawing    ###########################
my $rate1=$qlength/600;
my $rate2=$tlength/600;
...
my $pos2="target";
##draw query box
$svg=drawbox($qgene,$black,$svg,$rate1,$pos1);
$svg=drawbox($qdnate,$blue,$svg,$rate1,$pos1);
$svg=drawbox($qrnate,$red,$svg,$rate1,$pos1);
##draw target box
$svg=drawbox($tgene,$black,$svg,$rate2,$pos2);
$svg=drawbox($tdnate,$blue,$svg,$rate2,$pos2);
$svg=drawbox($trnate,$red,$svg,$rate2,$pos2);
...
close OUT;
       system "/home/jfchen/FFproject/tools/draw/svg2xxx_release/svg2xxx $file -m 500 -t pdf";
}
