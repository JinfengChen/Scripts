...
############# start block and print out head if there was a block interal
       ...
       if ($temprefstart-$startref > 10000){
           my $refhead=$os1."_".$chr."_".$startref."_".$temprefend;
           my $qryhead=$ob1."_".$chr."_".$startqry."_".$tempqryend;
...
######################################################################
       ...
       foreach(@$block){
           ...
           if ($refstart-$startref >= 4000000){
               my $refhead=$os1."_".$chr."_".$startref."_".$refend;
               my $qryhead=$ob1."_".$chr."_".$startqry."_".$qryend;  
               print "$qryhead\t$refhead\n";
