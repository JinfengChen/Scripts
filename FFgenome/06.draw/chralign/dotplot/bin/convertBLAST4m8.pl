...
my $help=<<USAGE;
Convert Blastm8 file from ortholog_paralog_pipeline to mcscan blast file.
...
my $python="python";
my $filter_blast="/home/jfchen/159/FFproject/tools/mcscan0.8/filter_blast.py";
...
while(<IN>){
   ...
   print OUT "$unit[0]\t$unit[1]\t$unit[10]\n";
}
close IN;
close OUT;
}
