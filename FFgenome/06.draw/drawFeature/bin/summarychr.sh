...
cat all.con.gff3.clear.chr.density | perl numberStat.pl -type mean:min:max
echo "DNA te mean min max"
cat all.con.RepeatMasker.out.gff.chr.DNA.density | perl numberStat.pl -type mean:min:max
echo "LTR te mean min max"
cat all.con.RepeatMasker.out.gff.chr.LTR.density | perl numberStat.pl -type mean:min:max
echo "Other te mean min max"
cat all.con.RepeatMasker.out.gff.chr.Other.density | perl numberStat.pl -type mean:min:max
echo "query"
echo "Gene mean min max"
