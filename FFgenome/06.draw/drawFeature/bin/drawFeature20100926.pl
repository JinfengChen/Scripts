...
$svg=barline($svg,$reflen->{$ref},$scale,"160");
...
my $minr6=0;
my $maxr6=1;
$svg=drawrefBED($svg,$opt{refmethy},$ref,$reflen->{$ref},$scale,$win,$step,$minr6,$maxr6,$binsetr6,"Methy");
...
my $minr7a=0;
my $maxr7a=1;
$svg=drawrefBED($svg,$opt{qrymethy},$ref,$scafchrlen,$scale,$win,$step,$minr7a,$maxr7a,$binsetr7a,"Methy");
