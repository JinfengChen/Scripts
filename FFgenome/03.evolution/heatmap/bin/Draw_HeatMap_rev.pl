...
open OUT,">>$target.HeatMap.svg" or die "$!";
...
sub draw_density{
	...
	my @type_arr= ( "Paralogues", "Genes (exons)", "DNA-TE/MITE", "DNA-TE/CACTA", "LTR-RT/copia", "LTR-RT/gypsy" );
